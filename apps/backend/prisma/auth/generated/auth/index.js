...
const config = {
  generator: {
    ...
    output: {
      value:
        "C:\\Users\\gebruiker\\source\\repos\\FileListShare\\apps\\backend\\prisma\\auth\\generated\\auth",
      fromEnvVar: null,
    },
    config: {
      engineType: "library",
    ...
    previewFeatures: [],
    sourceFilePath:
      "C:\\Users\\gebruiker\\source\\repos\\FileListShare\\apps\\backend\\prisma\\auth\\schema.prisma",
    isCustomOutput: true,
  },
  relativeEnvPaths: {
    rootEnvPath: null,
  ...
  inlineSchemaHash:
    "6ba13c9c426856f3fece1d937eee65e8fb0adfd25fb334436ecbbd4db1114e33",
  copyEngine: true,
};
...
path.join(
  process.cwd(),
  "prisma/auth/generated/auth/query_engine-windows.dll.node",
);
...
path.join(
  process.cwd(),
  "prisma/auth/generated/auth/libquery_engine-linux-musl-openssl-3.0.x.so.node",
);
// file annotations for bundling tools to include these files
