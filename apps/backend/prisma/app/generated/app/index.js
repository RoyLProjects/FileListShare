...
const config = {
  ...
  inlineSchemaHash:
    "2d6e0259e909a9db0d115b7a021fbd318fe2857c0128baa8fd016a33a05dfd21",
  copyEngine: true,
};
...
if (!fs.existsSync(path.join(__dirname, "schema.prisma"))) {
  const alternativePaths = ["prisma/app/generated/app", "app/generated/app"];
...
path.join(
  process.cwd(),
  "prisma/app/generated/app/query_engine-windows.dll.node",
);
...
path.join(
  process.cwd(),
  "prisma/app/generated/app/libquery_engine-linux-musl-openssl-3.0.x.so.node",
);
// file annotations for bundling tools to include these files
